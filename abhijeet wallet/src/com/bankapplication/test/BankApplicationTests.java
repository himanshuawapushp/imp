...
public class BankApplicationTests {
	...
	// throws NumberaAlreadyExistsException
	// {
	// Wallet wallet = new Wallet();
	// wallet.setBalance(new BigDecimal(500) );
	// assertEquals(account, accountServiceimpl.createAccount("112","Sagar",
	// wallet));
	// }
	...
	public void whenInvalidAccountNumberIsPassedForDeposit()
			throws MobileNumberDoesNotExistException, NumberaAlreadyExistsException {
	...
	@Test
	public void whenValidAccountNumberIsPassedSystemShouldDepositMoney()
			throws MobileNumberDoesNotExistException, NumberaAlreadyExistsException {
		Wallet wallet2 = new Wallet();
	...
	public void whenBalanceIsNotSufficientSystemShouldThrowException()
			throws InsufficientBalanceException, MobileNumberDoesNotExistException, NumberaAlreadyExistsException {
	...
	@Test
	public void whenBalanceIsSufficientAndAccountNumberIsCorrectSysytemShouldDeductMoney()
			throws MobileNumberDoesNotExistException, InsufficientBalanceException, NumberaAlreadyExistsException {
